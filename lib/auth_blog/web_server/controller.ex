defmodule AuthBlog.WebServer.Controller do
  ...
  @doc "Lists posts"
  @spec posts_index(req :: term(), params :: map()) :: {status_code :: pos_integer(), {:ok, list(Post.t())}}
  ...
  @doc "Updates post"
  @spec posts_update(req :: term(), params :: map())  :: {status_code :: pos_integer(), %{result: map()} | %{error: term()}}
